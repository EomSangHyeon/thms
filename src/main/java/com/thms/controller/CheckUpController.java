...
public class CheckUpController {
	...
	private CheckUpService service;
	 ...
	 @RequestMapping(value="/readPage", method=RequestMethod.GET)
		public void readPage(@RequestParam("chid") int chid,@ModelAttribute("cri")SearchCriteria cri, Model model) throws Exception {
		 	model.addAttribute(service.readPage(chid));
		}
	 
		
	 @RequestMapping(value="/modifyPage", method=RequestMethod.GET)
		public void updateGET(int chid,@ModelAttribute("cri") SearchCriteria cri, Model model) throws Exception {
		 	model.addAttribute(service.readPage(chid));
		}
	 @RequestMapping(value="/modifyPage", method=RequestMethod.POST)
		public String updatePOST(CheckUpVO vo,SearchCriteria cri, RedirectAttributes rttr) throws Exception {
	 ...
	 @ResponseBody
		...
		public void remove(@RequestParam("chid") int chid, SearchCriteria cri, RedirectAttributes rttr)throws Exception {
			service.delete(chid);
